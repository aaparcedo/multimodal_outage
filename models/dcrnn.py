...
from utils import load_adj, calculate_scaled_laplacian, calculate_random_walk_matrix
...
# randomadj = True
# adjdata = "data/graph/adj_mx_fl_k1.csv"
# adjtype = "doubletransition"
...
# test = DCRNNModel(adj_mx=mx, **kwargs)

# input = torch.rand(7, 1, 1072)
# output = test(input)
# output = output.view(7, 67, 16)
# print(output.shape)
